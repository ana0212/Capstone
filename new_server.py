...
pipeline = joblib.load('new_pipeline.pickle')
...
def predict():
    ...
    required_fields = ['age', 'sex', 'race', 'workclass', 'education', 'marital-status',
                       'capital-gain', 'capital-loss', 'hours-per-week', 'is_new'] # Added 'is_new'
    ...
    valid_categories = {
        ...
        "workclass": ["Private", "Self-emp-not-inc", "Self-emp-inc", "Federal-gov", "Local-gov", "State-gov", "Without-pay", "Never-worked", "No Salary"], # Updated workclass
        "education": ["Bachelors", "Some-college", "11th", "HS-grad", "Prof-school", "Assoc-acdm", "Assoc-voc", "9th", "7th-8th", "12th", "Masters", "1st-4th", "10th", "Doctorate", "5th-6th", "Preschool"],
        "marital-status": ["Married-civ-spouse", "Divorced", "Never-married", "Separated", "Widowed", "Married-spouse-absent", "Married-AF-spouse"],
        "is_new": ["True", "False"] # Added 'is_new'
    }
